...
export default function GameOver() {
    ...
    return (
        <main style={{ maxWidth: 720, margin: "80px auto", textAlign: "center", fontFamily: "system-ui, sans-serif", }}> 
            ...
            <div className="card bg-primary bg-base-100 w-100 h-90  shadow-xl rounded-small flex min-h justify-center items-center container mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
