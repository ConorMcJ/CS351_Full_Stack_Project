...
export default function MainMenu() {
    ...
    return (
        ...
        >
            ...
            <div className="card bg-primary bg-base-100 w-125 h-180  shadow-xl rounded-small flex min-h justify-center items-center container mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
